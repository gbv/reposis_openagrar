...
public class MCRCreateDateDOIGeneratorTI extends MCRPersistentIdentifierGenerator<MCRDigitalObjectIdentifier> {
    ...
    public MCRCreateDateDOIGeneratorTI(String generatorID) {
        super(generatorID);
