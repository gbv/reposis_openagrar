              ...
              <xsl:if test="$accessedit">
                ...
                <xsl:if
                        test="$MIR.registerDOI='true' and $accessedit 
                              ...
                              and not(.//mods:mods/mods:identifier[@type='doi'])"
                >
                  <xsl:if test="key('rights', $id)/@register-DataciteBfR">
                    <li>
                      <a href="#" data-mycoreID="{/mycoreobject/@ID}" data-register-pi="DataciteBfR" data-baseURL="{$WebApplicationBaseURL}">
                        <xsl:value-of select="i18n:translate('component.pi.register.doi.bfr')" />
                      </a>
                    </li>
                  </xsl:if>
                  <xsl:if test="key('rights', $id)/@register-DataciteTI">
                    <li>
                      <a href="#" data-mycoreID="{/mycoreobject/@ID}" data-register-pi="DataciteTI" data-baseURL="{$WebApplicationBaseURL}">
                        <xsl:value-of select="i18n:translate('component.pi.register.doi.ti')" />
                      </a>
                    </li>
                  </xsl:if>
                  <xsl:if test="key('rights', $id)/@register-DataciteJKI">  
                    <li>
                      <a href="#" data-mycoreID="{/mycoreobject/@ID}" data-register-pi="DataciteJKI" data-baseURL="{$WebApplicationBaseURL}">
                        <xsl:value-of select="i18n:translate('component.pi.register.doi.jki')" />
                      </a>
                    </li>
                  </xsl:if>
                </xsl:if>
